...
# 4. PDF Generation Logic (Using Helvetica for standard compatibility)
def generate_pdf_report(symbol, current, predicted):
    ...
    pdf.multi_cell(0, 10, txt="Disclaimer: This report is generated by an AI model. Trading involves significant risk.")
...
if df is not None:
    try:
        ...
        # Denormalization logic for daily close target
        ...
        if news_items:
            for item in news_items:
                # FIX: Using .get() ensures the app doesn't crash if 'title' is missing
