...
# 4. Data Engine (Fetch 5 days to ensure we have at least 60 minutes of data)
...
# SAFETY CHECK: Ensure we have at least 60 rows for the LSTM model
if df is not None and len(df) >= 60:
    try:
        ...
        st.subheader("Intraday Performance (Last 60 Minutes)")
    ...
    st.warning(f"Collecting live data... ({len(df)}/60 minutes captured). AI Model will activate shortly.")
else:
